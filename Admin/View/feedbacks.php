...
<head>
    ...
    <!-- Link with CSS root,feedbacks, nav bar , admin dashboard for seller controller,rating block -->
    <link rel="stylesheet" href="./resources/css/root.css">
    <link rel="stylesheet" href="./resources/css/navbar.css">
    <link rel="stylesheet" href="./resources/css/feedbacks.css">
...
<body>
    ...
    <div class="blocks">
        ...
        <div class="ratingBlock">
            ...
            <div class="percent">103</div> <span>Feedbacks</span>
        </div>
