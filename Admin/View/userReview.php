...
include "../Controller/reviewShopListController.php";
include "../Controller/userReviewDetailsController.php";
...
<head>
    ...
    <!-- Link with jquery and user review javascript -->
    <script src="./resources/js/jquery3.6.0.js"></script>
    <script src="./resources/js/userReview.js?v=<?=time()?>"></script>
   ...
   <nav class="navbar">
    ...
    <div class="ReviewedShopContainer">
        ...
        <div class="back-bar">
            ...
            <div class="back-text" id="back">Back</div>
        </div>
        ...
        <div class="shopListsContainer">
            ...
            <div class="shopNames">
                ...
                for ($i = 0; $i < count($shopNameResult); $i++) { ?>
                    <div id="shopName" data-shop-id=<?= $shopNameResult[$i]["shop_id"] ?>><?= $shopNameResult[$i]["shop_name"] ?></div>
                <?php }; ?>
            </div>
        </div>
    </div>
    
    <iconify-icon class="face" icon="ph:smiley-x-eyes-bold"></iconify-icon>
    <!-- Review Container -->
