$(document).ready(function () {
    $('#back').on("click",function(){
        window.location.href = '../View/userAccountList.php';
    })



    $(document).on("click","#shopName",function () {
        var shopId=$(this).data('shop-id');
        $(this).css('color', 'red').siblings().css('color', '');
        

        $.ajax({
            url: '../../Admin/Controller/userReviewDetailsController.php',
            type: 'POST',
            data: { shopId: shopId },
            dataType: 'json',
            ...
            success: function(data) {
              ...
              $.each(review,function(index,value){
                var html = '<div class="reviewBoxContainer">' +
                    '<div class="userDetails">' +
                    '<div class="userNameandDate">' +
                    '<div class="userName">' + value.user_name + '</div>' +
