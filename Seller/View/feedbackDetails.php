...
<body class="feedbackDetails_page">
    ...
    <div class="ms-md-4">
        ...
        <!-- page -->
        <div class="col-10">
            <p class="mt-2 mb-4 fw-bold h4 feedback-title">Feedback Details</p>
            <!-- percent and progress row -->
            <div class="row">
                <!-- for percent gp -->
                <div class="col-3">
                <div class="per-average">
                    <div class="per-face-text ms-3 mt-3">
                ...
                <div class="progress-gp">
                    ...
                    <div class="each-progress">
                        ...
                        <div class="progress w-50 mt-2 ms-3">
                            <div class="progress-bar" role="progressbar" style="width: 62%" aria-valuenow="62" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <span class="mt-2 ms-3 fw-bold total-review">62 reviews</span>
                    </div>
                    <!-- progress 2 -->
                    <div class="each-progress my-1">
                        ...
                        <span class="mt-2 ms-3 fw-bold total-review">20 reviews</span>
                    </div>
                    <!-- progress 3 -->
                    <div class="each-progress">
                        ...
                        <span class="mt-2 ms-3 fw-bold total-review">4 reviews</span>
                    </div>
                    <!-- progress 4 -->
                    <div class="each-progress my-1">
                        ...
                        <span class="mt-2 ms-3 fw-bold total-review">1 review</span>
                    </div>
                </div>
                </div>
            </div>
            ...
            <div>
                <div class="each-review ms-3">
                    <div class="details mt-2">
                        <div class="dis me-1 mt-2 ms-2"></div>
                        <span class="ms-3 fw-bold">username</span>
                        <img src="./resources/images/happy-face.png" class="ha-face">
                    </div>
                    <span class="ms-5 date">7 March 2023</span>
                    <p class="ms-5 user-text">
                ...
                <!-- for reply review -->
                <div class="each-review mt-4 ms-3 mb-sm-5">
                    <div class="details mt-2">
                        <div class="dis me-1 mt-2 ms-2"></div>
                        <span class="ms-3 fw-bold">username</span>
                        <img src="./resources/images/happy-face.png" class="ha-face">
                    ...
                    <div class="details mt-1">
                        ...
                        <span class="ms-3 fw-bold">sellername</span>
                        <img src="./resources/images/happy-face.png" class="ha-face">
                    </div>
                    <span class="ms-5 date">8 March 2023</span>
                    <p class="ms-5 seller-text">
